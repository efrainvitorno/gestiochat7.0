    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar variant="dense" className={classes.toolbar}>
          ...
          >
            {i18n.t("mainDrawer.appBar.message.hi")} {user.name}, {i18n.t("mainDrawer.appBar.message.text")} {system.name || "Gestio Chat"}
          </Typography>
          ...
          <div>
            ...
            >
              ...
              <span className={classes.systemCss}>
                <Link color="inherit" href={system.url || "https://github.com/efrainvitorno/gestiochatv3"}>
                  v{systemVersion}
                </Link>
              </span>
            </Menu>
